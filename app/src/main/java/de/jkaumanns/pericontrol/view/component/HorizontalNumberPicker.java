...
/**
 * Created by Joerg on 04.09.2016.
 */
...
//            postInvalidateOnAnimation(); // TODO
     ...
     * {@link de.jkaumanns.pericontrol.view.component.HorizontalNumberPicker#getInBoundsX(int)}
     *
    ...
    private static final class Marquee extends Handler {
        ...
        Marquee(HorizontalNumberPicker v, Layout l, boolean rtl) {
            ...
            mView = new WeakReference<HorizontalNumberPicker>(v);
        ...
        void tick() {
            ...
            final HorizontalNumberPicker view = mView.get();
    ...
    private static class PickerTouchHelper extends ExploreByTouchHelper {
        ...
        public PickerTouchHelper(HorizontalNumberPicker picker) {
            super(picker);
            mPicker = picker;
        }
